        ...
        <Card>
            <CardHeader className={'flex justify-between'}>
                ...
                <div className='flex items-center gap-2'>
                    <Button variant={'destructive'} className={'cursor-pointer'} disabled={removeLoading} onClick={removeLectureHandler}>
                        {
            ...
            <CardContent>
                ...
                <div className='flex items-center space-x-2 space-y-2 my-5'>
