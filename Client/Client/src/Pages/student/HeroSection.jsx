    ...
    return (
        <div className='relative bg-gradient-to-r from-blue-500 to bg-indigo-600 dark:from-gray-800 to dark:to-gray-900 py-20 px-4 text-center'>
            <div className='max-w-3xl mx-auto mt-7'>
                ...
                <form action="" className="flex items-center bg-white dark:bg-gray-800 rounded-full shadow-lg overflow-hidden max-w-2xl w-full mx-auto">
                    <input
                        type="text"
                    ...
                    />
                    <Button className="bg-blue-600 dark:bg-blue-700 h-full text-white px-6 rounded-r-full hover:bg-blue-700 dark:hover:bg-blue-800">
                        Search
                    </Button>
                    
                </form>
                <Button className="bg-white dark:bg-gray-800 text-blue-600 dark:text-gray-100 cursor-pointer rounded-full hover:bg-gray-200 mt-7">
                        Explore Courses
                </Button>
